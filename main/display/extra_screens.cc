...
static void update_fan_ui(void)
{
    ...
    if (s_fan_on) {
        ...
        lv_obj_set_style_bg_color(s_fan_btn, lv_color_hex(0x444444), LV_STATE_DEFAULT);
        lv_label_set_text(s_fan_txt, "FAN\nOFF");
        lv_obj_set_style_text_color(s_fan_txt, lv_color_hex(0x999999), LV_STATE_DEFAULT);
    }
}
...
static void update_light_ui(void)
{
    ...
    if (s_light_on) {
        ...
        lv_obj_set_style_bg_color(s_light_btn, lv_color_hex(0x444444), LV_STATE_DEFAULT);
        lv_label_set_text(s_light_txt, "LIGHT\nOFF");
        lv_obj_set_style_text_color(s_light_txt, lv_color_hex(0x999999), LV_STATE_DEFAULT);
    }
}
...
static lv_obj_t* create_tile_bg(lv_obj_t *parent, lv_color_t grad_top, lv_color_t grad_bottom)
{
    lv_coord_t sw = lv_disp_get_hor_res(NULL);
    lv_coord_t sh = lv_disp_get_ver_res(NULL);
    ...
    lv_obj_set_style_radius(bg, 0, LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(bg, 0, LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(bg, grad_top, LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(bg, grad_bottom, LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(bg, LV_GRAD_DIR_VER, LV_STATE_DEFAULT);
    lv_obj_clear_flag(bg, LV_OBJ_FLAG_SCROLLABLE);
    return bg;
}
...
void extra_screens_create(lv_obj_t *tv)
{
    ...
    create_tile_bg(tile0, lv_color_hex(0x55AB55), lv_color_hex(0x55ABDA));
    ...
    lv_obj_set_style_bg_color(dt_cont, lv_color_hex(0x000000), LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(dt_cont, LV_OPA_20, LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(s_timer_cont, lv_color_hex(0x000000), LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(s_timer_cont, LV_OPA_20, LV_STATE_DEFAULT);
    ...
    create_tile_bg(tile1, lv_color_hex(0x55AB55), lv_color_hex(0x55ABDA));
